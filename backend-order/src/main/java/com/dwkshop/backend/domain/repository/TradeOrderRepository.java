...
public interface TradeOrderRepository extends JpaRepository<TradeOrder, Long> {
    ...
    @Query("select o from TradeOrder o where o.id = :id and o.userId = :userId")
    Optional<TradeOrder> findByIdAndUserIdForUpdate(@Param("id") Long id, @Param("userId") Long userId);
